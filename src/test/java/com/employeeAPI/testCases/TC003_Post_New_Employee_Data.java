 ...
 *
 */
public class TC003_Post_New_Employee_Data extends TestBase {
	...
	void getEmployeeData() throws InterruptedException {
		logger.info("********** Started TC003_Post_New_Employee_Data **********");
	...
	@AfterClass
	void tearDown() {
		logger.info("********** Finished TC003_Post_New_Employee_Data **********");
	}
